...
var commands = [
    new builders_1.SlashCommandBuilder()
        ...
        .addStringOption(function (option) {
        return option.setName('status')
            .setDescription('Character status')
            .setRequired(true)
            .addChoices({ name: 'alive', value: 'alive' }, { name: 'dead', value: 'dead' });
    })
        ...
        .addStringOption(function (option) {
        return option.setName('class')
            .setDescription('Character class')
            .setRequired(true);
    })
        .addStringOption(function (option) {
        return option.setName('race')
            .setDescription('Character race')
            .setRequired(true);
    })
        .addStringOption(function (option) {
        return option.setName('zone')
    ...
    new builders_1.SlashCommandBuilder()
        ...
        .addStringOption(function (option) {
        return option.setName('field')
            .setDescription('Field to edit')
            .setRequired(true)
            .addChoices({ name: 'status', value: 'status' }, { name: 'level', value: 'level' }, { name: 'class', value: 'class' }, { name: 'race', value: 'race' }, { name: 'zone', value: 'zone' });
    })
        .addStringOption(function (option) {
